...
public class TotalCharactersInStringAfterTransformationsI_Leetcode3335 {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Result for abcyy is : " + lengthAfterTransformations("abcyy", 2)); // output -> 7
        // System.out.println("Result for azbk is : " + lengthAfterTransformations("azbk", 1));   // output -> 5
    }
